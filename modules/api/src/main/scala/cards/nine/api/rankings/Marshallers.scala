...
object NineCardsMarshallers {
  ...
  implicit lazy val ranking: ToResponseMarshaller[NineCardsServed[Result[Ranking]]] = {
    implicit val resM: ToResponseMarshaller[Ranking] =
      JsonSupport.circeJsonMarshaller(Encoders.ranking)
  ...
  implicit lazy val reloadResponse: ToResponseMarshaller[NineCardsServed[Result[Reload.Response]]] = {
    implicit val resM: ToResponseMarshaller[Reload.Response] =
      JsonSupport.circeJsonMarshaller(Encoders.reloadRankingResponse)
    val resultM: ToResponseMarshaller[Result[Reload.Response]] =
      ninecardsResultMarshaller[Reload.Response]
